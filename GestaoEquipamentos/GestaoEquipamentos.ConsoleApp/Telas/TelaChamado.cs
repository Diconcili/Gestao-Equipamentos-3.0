...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaChamado : TelaBase
    {
        ...
        public override void InserirNovoRegistro()
        {
            ...
            bool conseguiuGravar = GravarChamado(0, 0);
        ...
        public override void EditarRegistro()
        {
            ...
            bool conseguiuEditar = GravarChamado(idSelecionado, idSelecionado);
        ...
        private bool GravarChamado(int idChamadoSelecionado, int idSolicitanteChamado)
        {
